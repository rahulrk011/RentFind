  ...
  return (
    ...
    <header className='bg-slate-200 shadow-md'>
        <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
            <Link to='/'>
            <h1 className='font-extrabold text-pretty text-sm sm:text-xl flex flex-wrap'>
                <span className='text-slate-600'>RentHouse</span>
                <span className='text-slate-800'>Find</span>
            </h1>
            </Link>
